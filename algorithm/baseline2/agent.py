...
class Baseline2(Base):
    ...
    def __init__(self, env, log, tb_writer, args, name) -> None:
        super(Baseline2, self).__init__(env, log, tb_writer, args, name)
    ...
    def _get_actor_loss(self, timestep, stage):
        memory = self.memory_reg
    ...
    def _get_critic_loss(self, timestep, stage):
        memory = self.memory_reg
    ...
    def get_loss(self, agents, timestep, stage):
        ...
        self._get_actor_loss(timestep, stage)
        self._get_critic_loss(timestep, stage)
    ...
    def add_transition(self, obs, action, reward, next_obs, done, stage):
